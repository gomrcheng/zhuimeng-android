...
public class WKContentType extends WKMsgContentType {
    ...
    public final static int redpackgeRec = 67;//领取红包提示

    public final static int redpackgeRecTimeOut = 68;//过期

    public final static int redpackgeRecOver = 69;//全部领完
    //红包
    public static final int WK_RED_PACKAGE = 9;
    //红包领取
    public static final int WK_RED_PACKAGE_REC = 1011;
    //红包过期
    public static final int WK_RED_PACKAGE_REC_2 = 1012;
    //转账
