...
public class WKFileApplication {
    ...
    private void initFileListener(Context context) {
        ...
        EndpointManager.getInstance().setMethod(EndpointCategory.chatFunction + "_chooseFile", EndpointCategory.chatFunction, 1, object -> new ChatFunctionMenu("", R.mipmap.icon_func_file, context.getString(R.string.str_file_file), (iConversationContext) -> {
