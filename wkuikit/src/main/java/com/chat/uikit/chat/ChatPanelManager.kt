                            ...
                            while (i < itemCount) {
                                if (chatAdapter.getItem(i).isChecked) {
                                    if ((chatAdapter.getItem(i).wkMsg.type == WKContentType.WK_TEXT
                                                ...
                                                ) || (chatAdapter.getItem(i).wkMsg.type == WKContentType.WK_GIF || (chatAdapter.getItem(i).wkMsg.type == WKContentType.WK_VOICE))
                                    ){
                                        list.add(chatAdapter.getItem(i).wkMsg.baseContentMsgModel)
                                    }else {
                                        val textContent =
