...
public class WKVoiceViewManager {
    ...
    public View getVoiceView(IConversationContext iConversationContext) {
        ...
        try {
            ...
            JSONObject messageSendConfig = appConfig.message_send_config;
            String voice_max_duration_seconds = messageSendConfig.getString("voice_max_duration_seconds");
            maxRecordTime = Long.parseLong(voice_max_duration_seconds)*1000;
        }catch (Exception e){
            maxRecordTime = 60000;
        }
